const companyMapping = {
  'streetlife': {
    'talkabout.previous_jobs': 'I worked in Streetlife as a frontend developer from Aug 2016 to Jan 2017. Streetlife was a British leading online community for neighbourhood, connecting people together based on where they live. It was acquired by US unicorn Nextdoor in Jan 2017.\n\nI worked with two other frontend developers, contributing product ideas and developed different features on web platform that serve the needs of more than 1,500,000 active users and local businesses. I also helped revamping the website with ReactJS + Redux for better maintenance and performance.\n\nThe skills I used are mainly Javascript (ES6 + React + Redux)',
  ...
  'accedo': {
    ...
    'talkabout.previous_job.skill': 'The skills I used are mainly Javascript, HTML5 and CSS3.'
  },
  'hkgs': {
    'talkabout.previous_jobs': 'Hong Kong Good Store (hkgoodstore.com) is a non-commercial, independent part-time project co-founded in 2012 by me and 3 friends, trying to raise public awareness about the values of independent local stores in Hong Kong, a city of monopolization.\n\nWe are responsible for everything from making decision, applications development, online marketing to holding events. We built a web app and an iOS client making thousands of local independent shops searchable among the public. The iOS application once hit the Top Lifestyle App Chart on Hong Kong App Store. We also built a Facebook community (fb.com/hkgoodstore) with currently has 146,000+ organic followers in Hong Kong.\n\nThe skills I used in Hong Kong Good Store are mainly Javascript, HTML, CSS and ASP.Net.',
  ...
  'time_medical': {
    ...
    'talkabout.previous_job.skill': 'The skills I used in Time Medical are mainly .Net'
  },
  'not_mentioned': {
    ...
    'talkabout.previous_job.duration': 'Which company / project do you want to know? \n- Streetlife \n- Accedo \n- Hong Kong Good Store \n- e-Perfect \n- Vance Info \n- Time Medical',
    'talkabout.previous_job.company_size': 'Which company / project do you want to know? \n- Streetlife \n- Accedo \n- Hong Kong Good Store \n- e-Perfect \n- Vance Info \n- Time Medical'
  }
};

const skillMapping = {
  'not_mentioned': {
    'talkabout.skills': 'I am a senior frontend developer proficient in Javascript (ES6 + React + Redux), I also familiar with JQuery, Smart TV javascript frameworks and also backend skills like .Net, Java, Nodejs.\n\nIf you are interest to know more about specific skill, I am happy to tell you in detail.'
  },
  'javascript': {
  ...
  'frontend': {
    'talkabout.skills': 'I have 7 years of experience in frontend development, proficient in using Javascript to build web applications that serve over million of users. I have also helped revamping existing JQuery website with React and Redux.\n\nPersonally perfer using React and Redux in large application, I like Redux\'s unidirectional data flow and single source of truth which help maintainance and testing a lot.'
  },
  'backend': {
    'talkabout.skills': 'For backend development, I have experience in building a company HR system and also a local vessel system for Hong Kong governent from scratch. The technoloy I used are ASP.Net MVC and Java, I also have some experience with Nodejs in my side projects.'
  },
  'unit_test': {
    'talkabout.skills': 'I am familiar with using Mocha, Chai and Sinon to write unit tests in BDD.'
  },
  'smart_tv': {
    'talkabout.skills': 'I am familiar with Smart TV application development, its mainly Javascript, HTML5 and CSS3 like web applications, but the biggest challenge of it is that different TV platforms has different native api, e.g. a Samsung app couldn\'t run on a LG TV. When I worked in Accedo we solved this problem by adding an abstract layer on top of our application to talk with different TV platform, so that we can write one app and deploy to different platforms.'
  },
  'continuous_delivery': {
    'talkabout.skills': 'I have experience with continuous delivery when I was working in Streetlife. Application will be built and test suites will be run automatically, developer still need to run script to make deployment though, not a full automated process, but everything was pre-scripted with error handling to avoid any human errors.'
  },
  'dotnet': {
    'talkabout.skills': 'I have experience in building a company HR system with .Net'
  },
  'java': {
    'talkabout.skills': 'I have experience in building a local vessel system for Hong Kong governent from scratch.'
  },
  'node': {
  ...
  map: function (intent, parameters = {}) {
    ...
    switch (intent) {
      ...
      case 'talkabout.previous_job.skill':
        if (parameters.context_previous_job || parameters.previous_job) {
          previousJob = parameters.context_previous_job || parameters.previous_job;
        }
        return companyMapping[previousJob][intent];
      case 'talkabout.skills':
        if (parameters.skill) {
          skill = parameters.skill;
        }
        return skillMapping[skill][intent];
    }
  }
};
